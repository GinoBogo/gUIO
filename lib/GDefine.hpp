...
// clang-format off
#define BREAK_IF_AND_LOG(_condition, _type, _format, ...)         /**/ if (_condition) { LOG_FORMAT(_type, _format, __VA_ARGS__); break; }
#define BREAK_IF_AND(_condition, ...)                             /**/ if (_condition) { __VA_ARGS__; break; }
...
#define GOTO_IF_AND_LOG(_condition, _label, _type, _format, ...)  /**/ if (_condition) { LOG_FORMAT(_type, _format, __VA_ARGS__); goto _label; }
#define GOTO_IF_AND(_condition, _label, ...)                      /**/ if (_condition) { __VA_ARGS__; goto _label; }
...
#define RETURN_IF_AND_LOG(_condition, _type, _format, ...)        /**/ if (_condition) { LOG_FORMAT(_type, _format, __VA_ARGS__); return; }
#define RETURN_IF_AND(_condition, ...)                            /**/ if (_condition) { __VA_ARGS__; return; }
